...
# --- CONFIGURATION ---
FOLDER_PATH = "Insert path to the Databases folder in the Project directory" # Path to the folder containing CSV files
EMBEDDING_MODEL_NAME = "sentence-transformers/all-mpnet-base-v2"
BATCH_SIZE = 100  # Number of documents processed per batch
SAVE_PATH = os.path.join(FOLDER_PATH, "QA_db")  # FAISS storage file 
